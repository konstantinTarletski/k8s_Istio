...
> See: [README.md](../gateway-k8s-ingress/README.md)
...
```
### How to check 2
1. Do switch ON Ingress from here:[README.md](../gateway-k8s-ingress/README.md)
2. Do switch OFF ISTIO in Ingress from here: [README.md](../gateway-k8s-ingress/README.md)
